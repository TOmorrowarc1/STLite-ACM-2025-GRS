...
bool check2() { // Q.insert
  ...
  for (int i = 1; i <= 50; i++)
    Q[num[i]] = rand();
  int p = Q[6];
  if (Q.insert(sjtu::map<int, int>::value_type(6, 9)).second)
    return 0;
...
int Rand() { return Last = (A * Last + B) % Mod; }
